...
// cọc" (/manager/payments/deposits) theo yêu cầu người dùng — trước đây 2 nội dung này gộp chung 1
// bảng + 1 trang chi tiết có tab, giờ là 2 màn độc lập. Trang này chỉ tập trung vào quyết toán cuối
// kỳ; "Xem chi tiết" dẫn tới /manager/payments/settlements/[id] (chỉ hồ sơ quyết toán).
    ...
    },
    {
      ...
      render: (o) => (
        <div className="flex items-center gap-1">
          <Link
            href={`/manager/payments/settlements/${o.orderId}`}
