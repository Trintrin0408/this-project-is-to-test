...
// Trang thuần giao diện — xem giải thích ở đầu src/mocks/db/payments.ts. Port theo ảnh mẫu
...
export default function OrderPaymentDetailPage() {
  ...
  const handleConfirmSettlement = () => {
    confirmSettlement(order.orderId);
    refresh();
  };
  ...
  return (
    <div className="p-6">
      ...
      {tab === 'deposit' ? (
        ...
        <Reveal className="mt-5 rounded-2xl border border-slate-200 bg-white p-5">
          <div className="flex items-center justify-between">
            <p className="flex items-center gap-2 text-sm font-bold text-slate-900">
