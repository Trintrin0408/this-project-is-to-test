...
// toán" (quyết toán cuối kỳ). Nội dung đặt cọc giờ ở /admin/orders_audit/payments/[id]. Bố cục port
...
export default function OrderSettlementDetailPage() {
  ...
  if (!order) {
    return (
      <div className="p-6">
        ...
        <Link href="/admin/orders_audit/settlements" className="mt-2 inline-block text-sm font-medium text-blue-600 hover:underline">
          Quay lại danh sách
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-6">
      <Link href="/admin/orders_audit/settlements" className="mb-4 inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 hover:text-blue-600">
